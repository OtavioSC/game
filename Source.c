...
#include <allegro5/allegro_font.h>r--
    ...
    while (game_running) 
    {
        ...
        if (bIsMenu) {
            ...
            if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN && event.mouse.button == 1) {
                    ...
                    if (event.mouse.y >= 440 && event.mouse.y <= 520 && event.mouse.x >= 450 && event.mouse.x <= 750) {
                        bIsMenu = false;
                        bIsTutorial = true;
                    }
                  
                    if (event.mouse.y >= 540 && event.mouse.y <= 600 && event.mouse.x >= 450 && event.mouse.x <= 750) {
                        game_running = false;
                    }

                    if (event.mouse.y >= 100 && event.mouse.y <= 200 && event.mouse.x >= 1060 && event.mouse.x <= 1150) {
                        bIsMenu = false;
                        bIsOptions = true;
                    }
        ...
        if (bIsOptions) {
            ...
            if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN && event.mouse.button == 1) {
                    ...
                    if (event.mouse.y >= 600 && event.mouse.y <= 670 && event.mouse.x >= 450 && event.mouse.x <= 750) {
                        bIsMenu = true;
                        bIsOptions = false;
                    }
            ...
            if (event.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN && event.mouse.button == 1) {
                if (event.mouse.y >= 700 && event.mouse.y <= 800 && event.mouse.x >= 180 && event.mouse.x <= 400) {
                    bIsTutorial = false;
                    bIsMenu = false;
                    bIsGame = true;
                }
            ...
            if(bIsEndGame) {
                ...
                al_draw_text(Font, al_map_rgb(255, 255, 255), 620, 150, ALLEGRO_ALIGN_CENTER, "Press Enter to restart the game");
